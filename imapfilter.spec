...
Version  : 2.6.15
Release  : 9
URL      : https://github.com/lefcha/imapfilter/archive/v2.6.15/imapfilter-2.6.15.tar.gz
Source0  : https://github.com/lefcha/imapfilter/archive/v2.6.15/imapfilter-2.6.15.tar.gz
Summary  : A mail filtering utility for processing IMAP mailboxes
...
%prep
%setup -q -n imapfilter-2.6.15
cd %{_builddir}/imapfilter-2.6.15
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573763212
...
cp %{_builddir}/imapfilter-2.6.15/LICENSE %{buildroot}/usr/share/package-licenses/imapfilter/0cbcd7ef47d0cbba7c9ae50c405fe689f03201c6
%make_install
