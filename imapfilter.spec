...
Version  : 2.7.3
Release  : 11
URL      : https://github.com/lefcha/imapfilter/archive/v2.7.3/imapfilter-2.7.3.tar.gz
Source0  : https://github.com/lefcha/imapfilter/archive/v2.7.3/imapfilter-2.7.3.tar.gz
...
%prep
%setup -q -n imapfilter-2.7.3
cd %{_builddir}/imapfilter-2.7.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605721793
...
cp %{_builddir}/imapfilter-2.7.3/LICENSE %{buildroot}/usr/share/package-licenses/imapfilter/44978826bb7fd95c2a248312cd67ee7d0931e890
...
/usr/share/package-licenses/imapfilter/44978826bb7fd95c2a248312cd67ee7d0931e890
