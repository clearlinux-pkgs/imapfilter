...
Version  : 2.6.14
Release  : 8
URL      : https://github.com/lefcha/imapfilter/archive/v2.6.14/imapfilter-2.6.14.tar.gz
Source0  : https://github.com/lefcha/imapfilter/archive/v2.6.14/imapfilter-2.6.14.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572615257
...
cp %{_builddir}/imapfilter-2.6.14/LICENSE %{buildroot}/usr/share/package-licenses/imapfilter/0cbcd7ef47d0cbba7c9ae50c405fe689f03201c6
%make_install
